const char HTTP_APRS[] PROGMEM = R"=====(
<!DOCTYPE html>
<html lang="pl" style="height:100;">
     ...
     <style>
        ...
        <script type="text/javascript">
            ...
            window.onload = function (){
                ...
                xhttp.open("GET", "/json.htm?type=devices&rid=7", true);
                xhttp.send();
            }
    ...
    <div class=\"container\">
        ...
        <section>
            <div class="grid-container full"><big><b>Integracja z APRS / CWOP</b></big></div>
            <form action="/save_aprs" method="get">
            <div class="grid-container quarters">
                <div>
                    <label for="aprs_addr">Adres serwera</label>
                    <input class="input" name="aprs_addr" id="aprs_addr" type="text"  title="adres serwera dla CWOP ustaw cwop1.aprs.net" placeholder="cwop1.aprs.net">
                </div> 
                <div>
                    <label for="aprs_port">Port komunikacyjny</label>
                    <input class="input" name="aprs_port" id="aprs_port" type="text"  title="domyślnie 14580" placeholder="14580">
                </div>   
                <div>
                    <label for="aprs_send_interval">Interwał wysyłki danych</label>
                    <input class="input" name="aprs_send_interval" id="aprs_send_interval" type="number" min="5" max="60" step="1" title="interwał wysyłki danych w minutach" placeholder="10">
                </div>  
                <div>
                    <label for="aprs_on">Włącz integrację</label><br>
                    <input class="box" name="aprs_on" id="aprs_on" type="checkbox" value="1" title="włącz integrację z domoticzem"> 
                </div>                                            
            </div>
            <div class="grid-container quarters">
                <div>
                    <label for="aprs_user">Numer CWOP lub Znak </label>
                    <input class="input" name="aprs_user" id="aprs_user" type="text"  title="wpisz numer nadany przez CWOP lub znak krótkofalarski" placeholder="N0CALL">
                </div>   
                <div>
                    <label for="aprs_pass">Hasło</label>
                    <input class="input" name="aprs_pass" id="aprs_pass" type="text"  title="wpisz hasło dostępowe w przypadku CWOP pozostaw -1" placeholder="-1">
                </div>         
                <div>
                    <label for="aprs_lat">Pozycja długość</label>
                    <input class="input" name="aprs_lat" id="aprs_lat" type="text"  title="długość geograficzna w formacie APRS" placeholder="5500.01N">
                </div>    
                <div>
                    <label for="aprs_lon">Pozycja szerokość</label>
                    <input class="input" name="aprs_lon" id="aprs_lon" type="text"  title="szerokość geograficzna w formacie APRS" placeholder="02055.00E">
                </div>                                         
            </div>
            <div>&nbsp;</div>
            <div>
