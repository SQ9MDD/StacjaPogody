        ...
        <section>
            ...
            <div class="grid-container quarters">
                <div>
                    ...
                    <h2> <b id="Temp">wait...</b><b>C</b></h2>
                </div>
                <div>
                    <label for="Humidity">Wilgotność</label>
                    <h2> <b id="Humidity">wait...</b><b>%Rh</b></h2>
                </div>
                <div>
                    <label for="DewPoint">Punkt Rosy</label>
                    <h2> <b id="DewPoint">wait...</b><b>C</b></h2>
                </div>
                <div>
                    <label for="Barometer">Ciśnienie</label>
